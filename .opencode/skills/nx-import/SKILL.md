...
1. Install ESLint deps first: `npm install -wD eslint@^9 @nx/eslint-plugin typescript-eslint` (plus framework-specific plugins)
...
3. Install test runner deps: `npm install -wD jest jest-environment-jsdom ts-jest @types/jest`
